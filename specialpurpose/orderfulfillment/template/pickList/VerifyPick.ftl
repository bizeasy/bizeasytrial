...
<!--            <#if rowKey != counter>
    ...
    <#--
    <form name="printShipmentLabel" method="post" action="<@ofbizUrl>printShipmentLabel</@ofbizUrl>">
      <input type="hidden" name="orderId" value="${orderId!}"/>
      <input type="hidden" name="shipGroupSeqId" value="${shipGroupSeqId!}"/>
      <input type="hidden" name="facilityId" value="${facility.facilityId!}"/>
      <input type="hidden" name="userLoginId" value="${userLoginId!}"/>
      <#if pickRows?has_content>
        <div class="screenlet">
          ...
          <div class="screenlet-body">
            ...
            <div align="right">
              <a href="javascript:document.printShipmentLabel.submit()" class="buttontext">Print Label</a>
            </div>
          </div>
        </div>
      </#if>
