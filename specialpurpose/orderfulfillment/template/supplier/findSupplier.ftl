      ...
      <form method="post" name="lookupparty" action="<@ofbizUrl>FindSupplier</@ofbizUrl>" class="basic-form">
        ...
        <table class="basic-table" cellspacing="0">
          ...
          <tr>
            ...
            <td><@htmlTemplate.lookupField size="10" maxlength="22" formName="lookupparty" name="partyId" id="partyId" fieldFormName="SupplierLookupPartyName" /></td>
          </tr>
           <tr>
  ...
  <#if partyList?has_content>
    ...
    <#list partyList as partyRow>
      ...
      <#if partyRow.getModelEntity().isField("groupName") && partyRow.groupName?has_content>
          ${partyRow.groupName}
      <#else>
        <#assign partyName = Static["org.apache.ofbiz.party.party.PartyHelper"].getPartyName(partyRow, false)>
      ...
      <#else>
        ...
        <td>
      <#assign mainRole = dispatcher.runSync("getPartyMainRole", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("partyId", partyRow.partyId, "userLogin", userLogin))/>
