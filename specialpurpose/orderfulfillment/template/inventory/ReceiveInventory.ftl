                    ...
                    <td>
                      <table class="basic-table" cellspacing="0">
                        ...
                        <tr>
                         ...
                         <tr>
                          <td>&nbsp;</td>
                          <td align="right">Move Rejected Quantity To Scrap Location:</td>
                          <td align="right">
                            <#if scrapLocations?has_content>
                              <select name="scrapLocationSeqId_o_${rowCount}">
                              	<option value="">${uiLabelMap.ProductNoLocation}</option>
                                <#list scrapLocations as eachFacilityLocation>
                                  <option value="${eachFacilityLocation.locationSeqId}">${eachFacilityLocation.locationSeqId}</option>
                                </#list>
              ...
              <#-- <tr>
                ...
                <td>
                	<select name="productStoreId" >
                      ...
                      <option value="${store.productStoreId}">${store.title?if_exists}</option>
                      </#list>
                    </select>
                </td>
              </tr>
              <tr>
                ...
                <td>
                	<select name="facilityId">
                      ...
                      <option value="${facility.facilityId}">${facility.description?if_exists}</option>
                      </#list>
                    </select>
                </td>
              </tr>-->
