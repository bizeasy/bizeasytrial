...
import com.palredErp.services.ProductImportServices;

public class ProductAdminServices {
    public static final String module = ProductAdminServices.class.getName();
    ...
    public static Map<String, Object> loadProductDataToDB(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        String productStoreId = "L1_STORE";
        List<MessageString> error_list = new ArrayList<MessageString>();
        MessageString tmp = null;
        Debug.log("errorExists======"+errorExists);
        Debug.log("xlsFileName======"+xlsFileName);
        Debug.log("imageUrl======"+imageUrl);
        Debug.log("productLoadImagesDir======"+productLoadImagesDir);
        /*if(errorExists.equals("yes")) 
        {
            tmp = new MessageString("ProductLoaderError",productStoreId,true);
            error_list.add(tmp);
        }
        ...
        {
        Debug.log("Hello ==========xlsFileName====="+xlsFileName);
            String tempDir = (String)context.get("xlsFilePath");
            Debug.log("Hello ==========xlsFilePath====="+tempDir);
            ...
            try 
            {
                ...
                if(xlsDataFile.endsWith(".xls")) 
                {
                    ...
                    Debug.log("Calling importClientProductTemplate==================="+importClientProductTemplateCtx);
            ...
            {	
            	Debug.log("Error while calling xls upload====="+e,module);
                Debug.logWarning(e, module);
            }
        }
    ...
    public static Map<String, Object> uploadFile(DispatchContext dctx, Map<String, ? extends Object> context)
    {
        ...
        if (UtilValidate.isNotEmpty(xlsFileName))
        {
            ...
            String uploadTempDir = System.getProperty("ofbiz.home") + "/runtime/tmp/upload/";
        		...
        		Debug.logError("Error while uploading ======="+e,module);
        	} 
        }
        else 
        {
            //error_list.add(UtilProperties.getMessage("ProductAdminUiLabels", "BlankUploadFileError", locale));
            tmp = new MessageString( "BlankUploadFileError","_uploadedFile_fileName",true);
            error_list.add(tmp);
            return ServiceUtil.returnError(error_list);
        }
    ...
    public static Map<String, Object> deleteEntityRows(DispatchContext dctx, Map<String, ? extends Object> context)throws IOException, JDOMException 
    {
        ...
        if (UtilValidate.isNotEmpty(entityName)) {
                try {
                    ...
                    //error_list.add(UtilProperties.getMessage("ProductAdminUiLabels", e.getMessage(), locale));
                    tmp = new MessageString(e.getMessage(),"",true);
                    error_list.add(tmp);
            ...
            //error_list.add(UtilProperties.getMessage("ProductAdminUiLabels", "BlankEntityName", locale));
            tmp = new MessageString("BlankEntityName","entityDBName",true);
            error_list.add(tmp);
            return ServiceUtil.returnError(error_list);
        }
    ...
    public static Map<String, Object> deleteScheduledJobs(DispatchContext dctx, Map<String, ? extends Object> context) 
    {
        ...
        // send the notification
        String successMessage = UtilProperties.getMessage("ProductAdminUiLabels", "DeletedJobsSuccessMessage", UtilMisc.toList(deleteRowCount), locale);
