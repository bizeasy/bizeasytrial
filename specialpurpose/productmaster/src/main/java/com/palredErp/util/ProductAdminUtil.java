...
import com.palredErp.services.ProductManageXml;

public class ProductAdminUtil {

    public static final String module = ProductAdminUtil.class.getName();
    ...
    public static GenericValue getProductPriceForProductStore(ServletRequest request, String productId, String productPriceTypeId, String productStoreGroupId) {
        ...
        if(UtilValidate.isNotEmpty(productId) && UtilValidate.isNotEmpty(productPriceTypeId) && UtilValidate.isNotEmpty(productStoreGroupId))
        {
            try {
                productPriceList = delegator.findByAnd("ProductPrice", UtilMisc.toMap("productId", productId, "productPriceTypeId", productPriceTypeId, "productStoreGroupId",productStoreGroupId), UtilMisc.toList("-fromDate"),false);
    ...
    public static GenericValue getProductPrice(ServletRequest request, String productId, String productPriceTypeId) {
        ...
        {
            try {
                productPriceList = delegator.findByAnd("ProductPrice", UtilMisc.toMap("productId", productId, "productPriceTypeId", productPriceTypeId), UtilMisc.toList("-fromDate"),false);
                if(UtilValidate.isNotEmpty(productPriceList))
                {
                    productPriceListFiltered = EntityUtil.filterByDate(productPriceList);
                    if(UtilValidate.isNotEmpty(productPriceListFiltered))
  ...
  //Recusive method takes the root directory and returns the files from the folders and their subfolders 
    ...
    public static String buildProductImagePathExt(String productContentTypeId) 
    {
        ...
        String defaultImageDirectory = (String)imageLocationMap.get("DEFAULT_IMAGE_DIRECTORY_PRODUCTS");
    ...
    {
        String entryDateFormat = UtilProperties.getPropertyValue("productAdmin.properties", "entry-date-format");
    ...
    public static <K, V> Map <K, V> setSequenceMapByMultiple(final Map <K, V> sequenceMap, Integer multiple) 
    {
        ...
        try 
        {
            Map <K, Integer> sequenceSortedMap = new HashMap<K, Integer>();
    ...
    public static Map<String, Object> getCountryGeoInfo(Delegator delegator, String geoId) 
    {
        ...
        try 
        {
            ...
            geo = delegator.findOne("Geo", UtilMisc.toMap("geoId", geoId.toUpperCase()),true);
    ...
    public static String stripHTMLInLength(String content, String length)
   {
    ...
    public static String getNextSeqId(Delegator delegator, String seqName, String entityName, String entityPK)
    {
        ...
        try 
        {
    	    GenericValue gv = delegator.findOne(entityName, UtilMisc.toMap(entityPK, seqId),false);
