...
public class ShippingAddressType {
    ...
    @XmlElement(name = "ShippingContactNumber", required = true, defaultValue = "")//changed element name for shipping contact number
    protected String address3;
    @XmlElement(name = "CityTown", required = true, defaultValue = "")
    protected String cityTown;
    @XmlElement(name = "ShippingContactNumber", required = true, defaultValue = "")
    protected String shippingContactNumber;
   ...
   // @XmlElement(name = "District", required = true, defaultValue = "")
   // protected String district;
    ...
    /**
     * Gets the value of the shippingContactNumber property.
     * 
     * @return
     *     possible object is
     *     {@link String }
