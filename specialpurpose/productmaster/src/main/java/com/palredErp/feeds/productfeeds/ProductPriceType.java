...
public class ProductPriceType {
    ...
    @XmlElement(name = "B2BPrice", required = true)
    protected B2BPriceType b2bPrice;
    @XmlElement(name = "B2BPromoPrice", required = true)
    protected B2BPromoPriceType b2bPromoPrice;
    /**
    ...
    public B2BPriceType getB2BPrice() {
        return b2bPrice;
    }
    public void setB2BPrice(B2BPriceType value) {
        this.b2bPrice = value;
    }
    public B2BPromoPriceType getB2BPromoPrice() {
        return b2bPromoPrice;
    }
    public void setB2BPromoPrice(B2BPromoPriceType value) {
