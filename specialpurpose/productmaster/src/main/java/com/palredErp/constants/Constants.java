package com.palredErp.constants;
...
public class Constants {
    ...
    public static final String PRODUCT_B2BPRICE_DATA_KEY = "b2bPrice";
    public static final String PRODUCT_B2BPRICE_CUR_DATA_KEY = "b2bPriceCurrency";
    public static final String PRODUCT_B2BPRICE_FROM_DATA_KEY = "b2bPriceFromDate";
    public static final String PRODUCT_B2BPRICE_THRU_DATA_KEY = "b2bPriceThruDate";
    public static final String PRODUCT_B2BPROMOPRICE_DATA_KEY = "b2bPromoPrice";
    public static final String PRODUCT_B2BPROMOPRICE_CUR_DATA_KEY = "b2bPromoPriceCurrency";
    public static final String PRODUCT_B2BPROMOPRICE_FROM_DATA_KEY = "b2bPromoPriceFromDate";
    public static final String PRODUCT_B2BPROMOPRICE_THRU_DATA_KEY = "b2bPromoPriceThruDate";
