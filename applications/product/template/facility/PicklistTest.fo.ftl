	            	...
	            	<fo:table-body>
	            			...
	            			<fo:table-row>
		            			...
		            			<#list picklistInfo.picklistBinInfoList as picklistBinInfo>
		            				...
		            				<#assign noOfItemsInOrder = picklistItemInfoList.size()>
			            			...
			            			<fo:table-cell height="1.1in" padding-bottom="0.2in" >
				                    	<fo:block font-weight="bold" font-size="10">
				                      		&#160;(# ${count}) &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;    Pickup ${itemCount}/${noOfItemsInOrder}
				                      	</fo:block>
				                      	<fo:block>
					                      	<fo:table width="100%" table-layout="fixed">
								            	...
								            	<fo:table-body>
									                      ...
									                      <fo:block>
															<fo:instream-foreign-object>
											                    <barcode:barcode xmlns:barcode="http://barcode4j.krysalis.org/ns"
											                            message="${picklistBinInfo.primaryOrderHeader.orderId}">
											                        <barcode:code39>
					                      			...
					                      			<fo:table-row border-style="solid">
					                      				...
					                      				<fo:table-cell border-style="solid">
									                      <fo:block>
									                      	&#160;${picklistItemInfoList[0].inventoryItemAndLocation.locationSeqId}
									                      </fo:block>
									                    </fo:table-cell>
					                      			</fo:table-row>
					                      		</fo:table-body>
