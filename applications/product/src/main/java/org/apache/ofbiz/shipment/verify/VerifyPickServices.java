...
import org.apache.ofbiz.orderfulfillment.printer.Print;
...
public class VerifyPickServices {
	...
	public final static String module = VerifyPickServices.class.getName();
    ...
    public static Map<String, Object> completeVerifiedPick(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            try{
    			dispatcher.runSync("assignAirwayBillsForShipment", serviceContext);
    		}catch(Exception e){
    			Debug.logError(e, "Error in Printing Shipment and Invoice for order : " + orderId,module);
    			return ServiceUtil.returnError(e.getMessage());
    		}
            
            
            // Print Shipment Label and Invoice
               
    		/*try{
    			dispatcher.runSync("printShipmentLabelAndInvoice", serviceContext);
    		}catch(Exception e){
    			Debug.logError(e, "Error in Printing Shipment and Invoice for order : " + orderId,module);
    		}*/
