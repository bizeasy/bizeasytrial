...
<#escape x as x?xml>
    ...
    <fo:table-header height="14px">
      <fo:table-row  border="1pt solid" border-width=".1mm">
        <fo:table-cell>
          <fo:block font-weight="bold"  border="1pt solid" border-width=".1mm">${uiLabelMap.AccountingProduct}</fo:block>
        </fo:table-cell>
        <fo:table-cell>
          <fo:block font-weight="bold"  border="1pt solid" border-width=".1mm">${uiLabelMap.CommonDescription}</fo:block>
        </fo:table-cell>
        <fo:table-cell>
          <fo:block font-weight="bold" text-align="right"  border="1pt solid" border-width=".1mm">${uiLabelMap.CommonQty}</fo:block>
        </fo:table-cell>
        <fo:table-cell>
          <fo:block font-weight="bold" text-align="right"  border="1pt solid" border-width=".1mm">${uiLabelMap.AccountingUnitPrice}</fo:block>
        </fo:table-cell>
        <fo:table-cell>
          <fo:block font-weight="bold" text-align="right"  border="1pt solid" border-width=".1mm">${uiLabelMap.CommonAmount}</fo:block>
        </fo:table-cell>
      </fo:table-row>
    </fo:table-header>
    ...
    <fo:table-body font-size="10pt">
        ...
        <#list invoiceItems as invoiceItem>
            ...
            <#if !isItemAdjustment>
                <fo:table-row height="14px" space-start=".15in" border="1pt solid" border-width=".1mm">
                    <fo:table-cell>
                        <fo:block text-align="left"  border="1pt solid" border-width=".1mm">${invoiceItem.productId!} </fo:block>
                    </fo:table-cell>
                    <fo:table-cell  border="1pt solid" border-width=".1mm">
                        <fo:block text-align="left">${description!}</fo:block>
                    </fo:table-cell>
                      <fo:table-cell>
                        <fo:block text-align="right"  border="1pt solid" border-width=".1mm"> <#if invoiceItem.quantity??>${invoiceItem.quantity?string.number}</#if> </fo:block>
                    </fo:table-cell>
                    <fo:table-cell text-align="right"  border="1pt solid" border-width=".1mm">
